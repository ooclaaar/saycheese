...
# Edited by: https://github.com/ooclaaar/saycheese
...
printf " \e[1;77m v1.1 coded by  github.com/thelinuxchoice/saycheese and edited by github.com/ooclaaar/saycheese\e[0m \n"
printf "\n"
}
